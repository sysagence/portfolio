(function () {
  ...
  /**
   * Portfolio cards for #projects marquee (two identical strips are built in code for infinite scroll).
   * Edit this array only — index.html keeps an empty #projectsMarqueeTrack.
   */
  var PROJECTS_MARQUEE_ITEMS = [
    {
      href: "https://sysagence.github.io/ecoprowash1/",
      img: "https://res.cloudinary.com/drga4ofcz/image/upload/v1775394670/logo_sq0wkf.png",
      imgAlt: "",
      title: "EcoProwash",
      desc: "Industrial laundry for hotels & hospitals — asymmetric nav, hygiene focus, contact flows.",
    },
    {
      href: "https://ilpapavero.wuaze.com/",
      img: "https://res.cloudinary.com/drga4ofcz/image/upload/v1775394461/logo_cdygad.png",
      imgAlt: "",
      title: "Il Papavero",
      desc: "Brand-forward presence — elegant layout, clear navigation, contact-focused experience.",
    },
    {
      href: "https://stock-fabrics.wuaze.com/",
      img: "assets/images/project-stockfabrics.svg",
      imgAlt: "",
      title: "Stock Fabrics",
      desc: "Textiles & fabrics showcase — product-forward layout and strong brand presence.",
    },
    {
      href: "https://mourcup.wuaze.com/",
      img: "https://res.cloudinary.com/drga4ofcz/image/upload/v1775394579/morcup-logo_qgsztc.svg",
      imgAlt: "",
      title: "Mourcup",
      desc: "Morocco & FIFA World Cup 2030 — event narrative, organisation storytelling, cup-inspired identity.",
    },
    {
      href: "https://sysschool.wuaze.com/",
      img: "assets/images/logoo.svg",
      imgAlt: "",
      title: "SYS School",
      desc: "Learning platform — SYS-branded school experience, clear structure and resources.",
    },
    {
      href: "https://syscabin.wuaze.com/?i=1",
      img: "https://res.cloudinary.com/drga4ofcz/image/upload/v1775828673/Screenshot_2026-04-10_143121_xrqmbx.png",
      imgAlt: "Vasquez Family Clinic",
      title: "Vasquez Family Clinic",
      desc: "Healthcare landing — services, online booking, testimonials, and contact in a calm, modern layout.",
    },
    {
      href: "https://auranovajewelry.com/",
      img: "assets/images/auranovajewelry-logo.png",
      imgAlt: "Aura Nova Jewelry",
      title: "Aura Nova Jewelry",
      desc: "Jewelry brand presence — refined visuals, collection storytelling, and a premium shopping experience.",
    },
    {
      href: "https://syslocation.wuaze.com/",
      img: "assets/images/meridian-build-logo.png",
      imgAlt: "Meridian Build",
      title: "Meridian Build",
      desc: "Precision-led construction for landmark residential, commercial, and cultural spaces — delivered with clarity, craft, and uncompromising quality.",
    },
  ];

  function renderProjectsMarquee() {
    var track = document.getElementById("projectsMarqueeTrack");
    if (!track || !PROJECTS_MARQUEE_ITEMS.length) return;

    function makeCard(item, duplicateStrip) {
      var a = document.createElement("a");
      a.className = "projects-marquee__card";
      a.href = item.href;
      a.target = "_blank";
      a.rel = "noopener noreferrer";
      if (duplicateStrip) a.setAttribute("tabindex", "-1");

      var thumb = document.createElement("div");
      thumb.className = "projects-marquee__thumb";
      var img = document.createElement("img");
      img.className = "projects-marquee__img";
      img.src = item.img;
      img.alt = item.imgAlt != null ? item.imgAlt : "";
      img.width = 320;
      img.height = 200;
      img.loading = "lazy";
      img.decoding = "async";
      ...
      body.className = "projects-marquee__body";
      var titleEl = document.createElement("span");
      titleEl.className = "projects-marquee__title";
      titleEl.textContent = item.title;
      var descEl = document.createElement("span");
      descEl.className = "projects-marquee__desc";
    ...
    function makeSet(duplicateStrip) {
      var set = document.createElement("div");
      set.className = "projects-marquee__set";
      if (duplicateStrip) set.setAttribute("aria-hidden", "true");
      for (var i = 0; i < PROJECTS_MARQUEE_ITEMS.length; i++) {
        set.appendChild(makeCard(PROJECTS_MARQUEE_ITEMS[i], duplicateStrip));
      }
      return set;
    }
  ...
  function initProjectsMarquee() {
    ...
    function loop(now) {
      ...
      var pause =
        dragging ||
        (document.activeElement && marquee.contains(document.activeElement));
      if (!pause) {
    ...
    /* Defer setPointerCapture until the user moves past a small threshold so plain
       clicks on project <a> cards still open their href (immediate capture steals the click). */
    ...
    viewport.addEventListener(
      "pointermove",
      function (e) {
        if (!pressActive || e.pointerId !== activePointerId || segmentWidth <= 0) return;
    ...
    function onProjectsPointerEnd(e) {
    ...
    viewport.addEventListener("pointerup", onProjectsPointerEnd);
    viewport.addEventListener("pointercancel", onProjectsPointerEnd);
